  ...
  return (
    <div className="bg-gradient-to-r from-gray-800 to-black   flex justify-center items-center">
      <div className="grid gap-8 pb-4">
        <div className="bg-transparent  shadow-lg overflow-hidden h-[300px]">
          <img
            src={photo}
            alt="game"
            className="w-[600px] h-[300px] object-cover  shadow-lg transition-transform duration-500 transform hover:scale-105"
          />
        </div>
        ...
        <div className="bg-transparent rounded-xl p-6 text-white shadow-lg max-w-sm h-[300px]">
          ...
          <p className="text-xs mb-6 text-gray-400">{review}</p>
          </div>
          <Link
